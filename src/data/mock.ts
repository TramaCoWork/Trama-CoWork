...
export const categories: Category[] = [
  { id: 'architects', label: 'Architects', icon: 'architecture' },
  { id: 'designers', label: 'Designers', icon: 'palette' },
  { id: 'consultants', label: 'Consultants', icon: 'support_agent' },
  { id: 'developers', label: 'Developers', icon: 'code' },
  { id: 'legal', label: 'Legal Advisors', icon: 'gavel' },
  { id: 'brand', label: 'Brand Identity', icon: 'branding_watermark' },
];
...
export const professionals: Professional[] = [
  ...
  },
  {
    ...
    competencies: ['React', 'Node.js', 'TypeScript', 'AWS', 'PostgreSQL'],
    services: [
      { icon: 'code', title: 'Desarrollo Web', description: 'Aplicaciones web modernas con React y Node.js.' },
      { icon: 'cloud', title: 'Arquitectura Cloud', description: 'Diseno e implementacion de infraestructura en AWS.' },
    ],
  },
  {
    id: '6',
